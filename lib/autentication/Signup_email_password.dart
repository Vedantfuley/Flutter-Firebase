class SignUpWithEmailAndPasswordFailure {
  ...
  const SignUpWithEmailAndPasswordFailure([this.messgae="An Unknown error occured. "]);
  factory SignUpWithEmailAndPasswordFailure.code(String code) {
    switch(code){
      ...
      case 'invalid-email' :
        return const SignUpWithEmailAndPasswordFailure('E-mail is not valid or badly formatted. ');
